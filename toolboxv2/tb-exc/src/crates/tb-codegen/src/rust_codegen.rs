...
impl RustCodeGenerator {
    ...
    fn emit_preamble(&mut self) -> Result<()> {
        ...
        writeln!(self.buffer, "    String(String),")?;
        writeln!(self.buffer, "    Bool(bool),")?;
        writeln!(self.buffer, "    List(Vec<DictValue>),")?;
        writeln!(self.buffer, "    Dict(HashMap<String, DictValue>),")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer)?;

        // ✅ Helper methods for DictValue
        writeln!(self.buffer, "impl DictValue {{")?;
        writeln!(self.buffer, "    fn as_int(&self) -> i64 {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Int(i) => *i,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected Int\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn as_string(&self) -> &str {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::String(s) => s,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected String\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn as_float(&self) -> f64 {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Float(f) => *f,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected Float\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn as_bool(&self) -> bool {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Bool(b) => *b,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected Bool\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn get(&self, key: &str) -> Option<&DictValue> {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Dict(map) => map.get(key),")?;
        writeln!(self.buffer, "            _ => None,")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn as_dict(&self) -> &HashMap<String, DictValue> {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Dict(map) => map,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected Dict\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer)?;
        writeln!(self.buffer, "    fn as_list(&self) -> &Vec<DictValue> {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::List(v) => v,")?;
        writeln!(self.buffer, "            _ => panic!(\"Expected List\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer)?;

        // ✅ Implement Display for DictValue
        writeln!(self.buffer, "impl std::fmt::Display for DictValue {{")?;
        writeln!(self.buffer, "    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {{")?;
        writeln!(self.buffer, "        match self {{")?;
        writeln!(self.buffer, "            DictValue::Int(i) => write!(f, \"{{}}\", i),")?;
        writeln!(self.buffer, "            DictValue::Float(fl) => write!(f, \"{{}}\", fl),")?;
        writeln!(self.buffer, "            DictValue::String(s) => write!(f, \"{{}}\", s),")?;
        writeln!(self.buffer, "            DictValue::Bool(b) => write!(f, \"{{}}\", b),")?;
        writeln!(self.buffer, "            DictValue::List(_) => write!(f, \"[...]\"),")?;
        writeln!(self.buffer, "            DictValue::Dict(_) => write!(f, \"{{{{...}}}}\"),")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer)?;

        // ✅ Implement PartialOrd for DictValue to allow comparisons
        writeln!(self.buffer, "impl PartialOrd for DictValue {{")?;
        writeln!(self.buffer, "    fn partial_cmp(&self, other: &Self) -> Option<std::cmp::Ordering> {{")?;
        writeln!(self.buffer, "        match (self, other) {{")?;
        writeln!(self.buffer, "            (DictValue::Int(a), DictValue::Int(b)) => a.partial_cmp(b),")?;
        writeln!(self.buffer, "            (DictValue::Float(a), DictValue::Float(b)) => a.partial_cmp(b),")?;
        writeln!(self.buffer, "            (DictValue::String(a), DictValue::String(b)) => a.partial_cmp(b),")?;
        writeln!(self.buffer, "            (DictValue::Bool(a), DictValue::Bool(b)) => a.partial_cmp(b),")?;
        writeln!(self.buffer, "            (DictValue::Int(a), DictValue::Float(b)) => (*a as f64).partial_cmp(b),")?;
        writeln!(self.buffer, "            (DictValue::Float(a), DictValue::Int(b)) => a.partial_cmp(&(*b as f64)),")?;
        writeln!(self.buffer, "            _ => None,")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        ...
        // ✅ Implement PartialEq and PartialOrd for DictValue with primitive types
        writeln!(self.buffer, "impl PartialEq<i64> for DictValue {{")?;
        writeln!(self.buffer, "    fn eq(&self, other: &i64) -> bool {{")?;
        writeln!(self.buffer, "        match self {{ DictValue::Int(i) => i == other, _ => false }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer, "impl PartialOrd<i64> for DictValue {{")?;
        writeln!(self.buffer, "    fn partial_cmp(&self, other: &i64) -> Option<std::cmp::Ordering> {{")?;
        writeln!(self.buffer, "        match self {{ DictValue::Int(i) => i.partial_cmp(other), _ => None }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer, "impl PartialEq<f64> for DictValue {{")?;
        writeln!(self.buffer, "    fn eq(&self, other: &f64) -> bool {{")?;
        writeln!(self.buffer, "        match self {{ DictValue::Float(f) => f == other, _ => false }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer, "impl PartialOrd<f64> for DictValue {{")?;
        writeln!(self.buffer, "    fn partial_cmp(&self, other: &f64) -> Option<std::cmp::Ordering> {{")?;
        writeln!(self.buffer, "        match self {{ DictValue::Float(f) => f.partial_cmp(other), _ => None }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer, "impl PartialEq<&str> for DictValue {{")?;
        writeln!(self.buffer, "    fn eq(&self, other: &&str) -> bool {{")?;
        writeln!(self.buffer, "        match self {{ DictValue::String(s) => s == other, _ => false }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer)?;

        // ✅ FIX #1: Implement PartialEq for DictValue
        writeln!(self.buffer, "impl PartialEq for DictValue {{")?;
        writeln!(self.buffer, "    fn eq(&self, other: &Self) -> bool {{")?;
        writeln!(self.buffer, "        match (self, other) {{")?;
        writeln!(self.buffer, "            (DictValue::Int(a), DictValue::Int(b)) => a == b,")?;
        writeln!(self.buffer, "            (DictValue::Float(a), DictValue::Float(b)) => a == b,")?;
        writeln!(self.buffer, "            (DictValue::String(a), DictValue::String(b)) => a == b,")?;
        writeln!(self.buffer, "            (DictValue::Bool(a), DictValue::Bool(b)) => a == b,")?;
        writeln!(self.buffer, "            _ => false,")?;
        writeln!(self.buffer, "        }}")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer)?;
        ...
        // Built-in functions
        writeln!(self.buffer, "// Built-in functions")?;

        // Helper function for printing floats with proper formatting
        writeln!(self.buffer, "fn print_float(value: f64) {{")?;
        writeln!(self.buffer, "    if value.fract() == 0.0 && value.is_finite() {{")?;
        writeln!(self.buffer, "        println!(\"{{:.1}}\", value);")?;
        writeln!(self.buffer, "    }} else {{")?;
        writeln!(self.buffer, "        println!(\"{{}}\", value);")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        writeln!(self.buffer, "fn print<T: std::fmt::Display>(value: T) {{ println!(\"{{}}\", value); }}")?;

        // Polymorphic len() function using trait
        writeln!(self.buffer, "// Polymorphic len() function")?;
        writeln!(self.buffer, "trait Len {{ fn tb_len(&self) -> i64; }}")?;
        writeln!(self.buffer, "impl<T> Len for Vec<T> {{ fn tb_len(&self) -> i64 {{ self.len() as i64 }} }}")?;
        writeln!(self.buffer, "impl<T> Len for &[T] {{ fn tb_len(&self) -> i64 {{ self.len() as i64 }} }}")?;
        writeln!(self.buffer, "impl Len for String {{ fn tb_len(&self) -> i64 {{ self.len() as i64 }} }}")?;
        writeln!(self.buffer, "impl Len for &str {{ fn tb_len(&self) -> i64 {{ self.len() as i64 }} }}")?;
        writeln!(self.buffer, "impl Len for DictValue {{ fn tb_len(&self) -> i64 {{ match self {{ DictValue::List(v) => v.len() as i64, DictValue::Dict(m) => m.len() as i64, DictValue::String(s) => s.len() as i64, _ => 0 }} }} }}")?;
        writeln!(self.buffer, "impl<K, V> Len for HashMap<K, V> {{ fn tb_len(&self) -> i64 {{ self.len() as i64 }} }}")?;
        writeln!(self.buffer, "fn len<T: Len>(collection: &T) -> i64 {{ collection.tb_len() }}")?;

        // Polymorphic int() and float() functions
        writeln!(self.buffer, "trait ToInt {{ fn to_int(&self) -> i64; }}")?;
        writeln!(self.buffer, "impl ToInt for bool {{ fn to_int(&self) -> i64 {{ if *self {{ 1 }} else {{ 0 }} }} }}")?;
        writeln!(self.buffer, "impl ToInt for i64 {{ fn to_int(&self) -> i64 {{ *self }} }}")?;
        writeln!(self.buffer, "impl ToInt for f64 {{ fn to_int(&self) -> i64 {{ *self as i64 }} }}")?;
        writeln!(self.buffer, "impl ToInt for &str {{ fn to_int(&self) -> i64 {{ self.parse().unwrap_or(0) }} }}")?;
        writeln!(self.buffer, "impl ToInt for String {{ fn to_int(&self) -> i64 {{ self.parse().unwrap_or(0) }} }}")?;
        writeln!(self.buffer, "fn int<T: ToInt>(value: T) -> i64 {{ value.to_int() }}")?;

        writeln!(self.buffer, "trait ToFloat {{ fn to_float(&self) -> f64; }}")?;
        writeln!(self.buffer, "impl ToFloat for i64 {{ fn to_float(&self) -> f64 {{ *self as f64 }} }}")?;
        writeln!(self.buffer, "impl ToFloat for &str {{ fn to_float(&self) -> f64 {{ self.parse().unwrap_or(0.0) }} }}")?;
        writeln!(self.buffer, "impl ToFloat for String {{ fn to_float(&self) -> f64 {{ self.parse().unwrap_or(0.0) }} }}")?;
        writeln!(self.buffer, "fn float<T: ToFloat>(value: T) -> f64 {{ value.to_float() }}")?;
        writeln!(self.buffer, "fn str<T: std::fmt::Display>(value: T) -> String {{ format!(\"{{}}\", value) }}")?;
        writeln!(self.buffer, "fn range(start: i64, end: Option<i64>) -> Vec<i64> {{")?;
        writeln!(self.buffer, "    match end {{")?;
        writeln!(self.buffer, "        Some(e) => (start..e).collect(),")?;
        writeln!(self.buffer, "        None => (0..start).collect(),")?;
        writeln!(self.buffer, "    }}")?;
        writeln!(self.buffer, "}}")?;
        // ✅ PHASE 2: push() accepts value directly, not reference
        writeln!(self.buffer, "fn push<T>(mut vec: Vec<T>, item: T) -> Vec<T> {{ vec.push(item); vec }}")?;
        writeln!(self.buffer, "fn pop<T: Clone>(mut vec: Vec<T>) -> Vec<T> {{ vec.pop(); vec }}")?;
        writeln!(self.buffer, "fn keys<K: Clone, V>(map: &HashMap<K, V>) -> Vec<K> {{ map.keys().cloned().collect() }}")?;
        writeln!(self.buffer, "fn values<K, V: Clone>(map: &HashMap<K, V>) -> Vec<V> {{ map.values().cloned().collect() }}")?;
        ...
        match expr {
            ...
            Expression::Call { callee, args, .. } => {
                ...
                if let Expression::Ident(name, _) = callee.as_ref() {
                    if name.as_str() == "range" {
                        ...
                        if matches!(arg_type, Type::Float) {
                            write!(self.buffer, "print_float(")?;
                            self.generate_expression(&args[0])?;
                            write!(self.buffer, ")")?;
                            return Ok(());
                        }
                    ...
                    // JSON functions
                        ...
                        write!(self.buffer, "serde_json::to_string(&")?;
                        self.generate_expression(&args[0])?;
                        write!(self.buffer, ").unwrap_or_default()")?;
                        return Ok(());
                    } else if name.as_str() == "json_parse" {
                        self.uses_serde_json = true;
                        write!(self.buffer, "serde_json::from_str::<serde_json::Value>(&")?;
                        self.generate_expression(&args[0])?;
                    ...
                    // YAML functions
                        ...
                        write!(self.buffer, "serde_yaml::to_string(&")?;
                        self.generate_expression(&args[0])?;
                        write!(self.buffer, ").unwrap_or_default()")?;
                        return Ok(());
                    } else if name.as_str() == "yaml_parse" {
                        self.uses_serde_yaml = true;
                        write!(self.buffer, "serde_yaml::from_str::<serde_yaml::Value>(&")?;
                        self.generate_expression(&args[0])?;
                        write!(self.buffer, ").ok()")?;
                        return Ok(());
                    }
            ...
            Expression::Dict { entries, .. } => {
                if entries.is_empty() {
                    ...
                    // Homogeneous dict - use specific type (as before)
                    write!(self.buffer, "{{ ")?;
                    write!(self.buffer, "let mut map = HashMap::new(); ")?;
                    for (key, value) in entries {
        ...
        match expr {
            ...
            Expression::Dict { entries, .. } => {
                if entries.is_empty() {
                    ...
                    let value_type = self.infer_expr_type(&entries[0].1)?;
                    Ok(Type::Dict(Box::new(Type::String), Box::new(value_type)))
                }
            }
            Expression::Ident(name, _) => {
    ...
    fn dict_needs_enum(&self, entries: &[(Arc<String>, Expression)]) -> bool {
        ...
        let first_type = self.infer_expr_type(&entries[0].1).ok();

        for (_, value) in &entries[1..] {
            let value_type = self.infer_expr_type(value).ok();
            if value_type != first_type {
                return true;  // Heterogeneous - needs enum
            }
        }

        false  // Homogeneous - can use specific type
    }
