"""Automatic generated by ToolBox v = 0.1.7"""
...
class SOCKETMANAGER(Enum):
    ...
    SEND_FILE_TO_SEVER: str = 'send_file_to_sever'
    RECEIVE_AND_DECOMPRESS_FILE_AS_SERVER: str = 'receive_and_decompress_file_as_server'
    SEND_FILE_TO_PEER: str = 'send_file_to_peer'
    RECEIVE_AND_DECOMPRESS_FILE: str = 'receive_and_decompress_file'
    APP_INSTANCE: str = 'app_instance'
    APP_INSTANCE_TYPE: str = 'app_instance_type'
...
class DASHPROVIDER(Enum):
    ...
    GETSMSG: str = 'getsMSG'
    GETSINSIGHTSWIDGET: str = 'getsInsightsWidget'
...
class AUDIO(Enum):
    NAME = 'audio'
    ON_STARTUP: str = 'on_startup'
    ON_START: str = 'on_start'
    INIT_SPEECH: str = 'init_speech'
    ON_CLOSE: str = 'on_close'
    ON_EXIT: str = 'on_exit'
    SPEECH: str = 'speech'
    SPEECH_STREAM: str = 'speech_stream'
    TRANSCRIPT: str = 'transcript'
    WAKE_WORD: str = 'wake_word'
    TRANSCRIPT_STREAM: str = 'transcript_stream'
    APP_INSTANCE: str = 'app_instance'
    APP_INSTANCE_TYPE: str = 'app_instance_type'
...
class ISAA(Enum):
    ...
    LOAD_TASK: str = 'load_task'
    GET_TASK: str = 'get_task'
    LIST_TASK: str = 'list_task'
    SAVE_TO_MEM: str = 'save_to_mem'
    SET_LOCAL_FILES_TOOLS: str = 'set_local_files_tools'
