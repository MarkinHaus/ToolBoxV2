"""Automatic generated by ToolBox v = 0.1.14"""
...
class SOCKETMANAGER(Enum):
    ...
    SOCKETMANAGER_0: str = 'SocketManager_0'  # Input: (['name', 'host', 'port', 'type_id', 'max_connections', 'endpoint_port', 'return_full_object', 'keepalive_interval', 'test_override', 'package_size', 'start_keep_alive', 'unix_file', 'do_async']), Output: <class 'toolboxv2.utils.system.types.Result'>
...
class SCHEDULERMANAGER(Enum):
    ...
    APP_INSTANCE: str = 'app_instance'  # Input: (), Output: None
    APP_INSTANCE_TYPE: str = 'app_instance_type'  # Input: (), Output: None
    SCHEDULERMANAGER_1: str = 'SchedulerManager_1'  # Input: ([]), Output: <class 'inspect._empty'>
...
class WIDGETSPROVIDER(Enum):
    ...
    SAVE_USER_STO: str = 'save_user_sto'  # Input: (['app', 'request', 'name']), Output: <class 'inspect._empty'>
    GET_USER_STO: str = 'get_user_sto'  # Input: (['app', 'request', 'name']), Output: <class 'inspect._empty'>
...
class FASTAPI(Enum):
    ...
    STARTE: str = 'startE'  # Input: (['api_name', 'live', 'reload', 'test_override']), Output: <class 'inspect._empty'>
    STARTDEV: str = 'startDev'  # Input: (['api_name', 'modules']), Output: <class 'inspect._empty'>
...
class AUDIO(Enum):
    ...
    APP_INSTANCE: str = 'app_instance'  # Input: (), Output: None
    APP_INSTANCE_TYPE: str = 'app_instance_type'  # Input: (), Output: None
    AUDIO_0: str = 'audio_0'  # Input: ([]), Output: <class 'inspect._empty'>
...
class DIFFUSER(Enum):
    ...
    APP_INSTANCE: str = 'app_instance'  # Input: (), Output: None
    APP_INSTANCE_TYPE: str = 'app_instance_type'  # Input: (), Output: None
    DIFFUSER_0: str = 'diffuser_0'  # Input: ([]), Output: <class 'inspect._empty'>
    DIFFUSER_1: str = 'diffuser_1'  # Input: ([]), Output: <class 'inspect._empty'>