...
class WSConnection:
    ...
    cloudm_user_id: str = ""  # Clerk user ID for authentication
...
class WSWorker:
    ...
    async def _handle_connection_impl(self, websocket, path: str):
        ...
        logger.info(f"[WS] Connection {conn_id}: user_id={conn.user_id}, cloudm_user_id={conn.cloudm_user_id}, level={conn.level}, authenticated={conn.authenticated}")
        ...
        await self._safe_publish(
            Event(
                ...
                payload={
                    ...
                    "level": conn.level,
                    "cloudm_user_id": conn.cloudm_user_id,
