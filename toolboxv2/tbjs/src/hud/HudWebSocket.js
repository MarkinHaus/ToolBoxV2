...
import { getNotificationManager } from '../core/notifications.js';
        ...
        try {
            ...
            this.ws.onmessage = (e) => {
                try {
                    ...
                    // Notifications abfangen und an NotificationManager weiterleiten
                    if (data.type === 'notification') {
                        const nm = getNotificationManager();
                        nm.init(); // idempotent
                        nm.handleWsMessage(data);
                        // Trotzdem an Callback weiterleiten (für Logging etc.)
                    }
