...
from toolboxv2.tests.test_isaa.test_base.test_agent.conftest2 import  AsyncTestCase, MockAgentModelData, MockMemory
...
class TestVirtualFileSystem(AsyncTestCase):
    ...
    def test_14_list_files(self):
        ...
        self.assertEqual(len(lst['files']), 4, f"{lst['files']}=") # a, b, system_context.md, vfs_guid.md
