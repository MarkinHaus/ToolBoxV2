...
def set_up_app_for_isaa_talk(app, mem):
    ...
    app.AC_MOD.add_str_to_config(["", 'WOLFRAM_ALPHA_APPID', "JLQ8U8-5Y9KW29XJ2"])
    app.AC_MOD.add_str_to_config(["", 'HUGGINGFACEHUB_API_TOKEN', "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"])
    app.AC_MOD.add_str_to_config(["", 'OPENAI_API_KEY', "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"])
    app.AC_MOD.add_str_to_config(["", 'REPLICATE_API_TOKEN', "d04ce27545fda4b7e3c344e4470c10e8a20b06ea"])
    app.AC_MOD.add_str_to_config(["", 'IFTTTKey', "n4j4wfvpWhFI8Ba2F1Dfp5sjhdWpbMV6cc180JZn2zn"])
    app.AC_MOD.add_str_to_config(
        ["", 'SERP_API_KEY', "24fbc9ab43b0eaf10e7432dc73d4e0a69950d9510bdedb380889aa8c07d56971"])
...
def _run_isaa_verb(app: App, c=3.5, awake=True):
