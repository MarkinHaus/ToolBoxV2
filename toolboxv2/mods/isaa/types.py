...
class SupTask(BaseModel):
    ...
    tools: Optional[bool] = Field(..., description="If the subtask needs tool usage")
...
class TaskChain(BaseModel):
    ...
    dis: Optional[str] = Field(None, description="Optional description or additional information about the task chain")
