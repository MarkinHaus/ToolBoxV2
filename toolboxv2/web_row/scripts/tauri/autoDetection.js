document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!window.__TAURI__) {
        window.location.href = '/web/dashboards/user_dashboard.html'
    } else {
...
// Funktion zum Ausführen von Toolbox-Befehlen
        function runToolboxCommand(command) {
            return new Promise((resolve, reject) => {
                const child = spawn('python', ['toolbox_cli.py', ...command]);
                let output = '';
...
// Initialisierungsfunktion
        ...
        window.location.href = '/web/dashboards/widgetbord.html'
    }
