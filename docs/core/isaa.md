...
*   **Advanced Agent Core**: Powered by the new **[FlowAgent](../new/old_docs/agent.md)**, which features an outline-driven reasoning loop, sub-system orchestration, and auto-recovery.
...
For a comprehensive guide on the internal architecture, capabilities, and API of the `FlowAgent` itself, please refer to the **[FlowAgent Documentation](../new/old_docs/agent.md)**.
