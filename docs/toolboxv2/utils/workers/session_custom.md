...
- [`user_id`](utils/system/types.md) from `toolboxv2/utils/system/types.py`

## Used By

- Referenced by `invalidate_session` in [session](utils/workers/session.md)
...
- Referenced by `__init__` in [pyshell](flows/pyshell.md)