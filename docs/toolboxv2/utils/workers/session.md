...
- [`pem_to_public_key`](../../utils/security/cryp.md) from `toolboxv2/utils/security/cryp.py`
- [`DataAccessLog`](../../mods/CloudM/UserDataAPI.md) from `toolboxv2/mods/CloudM/UserDataAPI.py`
- [`generate_authorization_url`](../../mods/WhatsAppTb/client.md) from `toolboxv2/mods/WhatsAppTb/client.py`
- [`save_user_stats`](../../mods/UltimateTTT.md) from `toolboxv2/mods/UltimateTTT.py`
- [`add_collection_to_group_wrapper`](../../mods/MinimalHtml.md) from `toolboxv2/mods/MinimalHtml.py`
- [`get_search_only_tools`](../../mods/isaa/extras/web_helper/tooklit.md) from `toolboxv2/mods/isaa/extras/web_helper/tooklit.py`
- [`a_format_class`](../../mods/isaa/base/Agent/flow_agent.md) from `toolboxv2/mods/isaa/base/Agent/flow_agent.py`
- [`register_api_endpoints`](../../mods/videoFlow/api/generation.md) from `toolboxv2/mods/videoFlow/api/generation.py`
- [`_needs_continuation`](../../flows/pyshell.md) from `toolboxv2/flows/pyshell.py`
- [`_stats_for_keys`](../../mods/isaa/base/IntelligentRateLimiter/intelligent_rate_limiter.md) from `toolboxv2/mods/isaa/base/IntelligentRateLimiter/intelligent_rate_limiter.py`

## Used By

- [`markdown_to_svg`](../../mods/Canvas.md) in `toolboxv2/mods/Canvas.py`
- [`speak`](../../mods/TTS.md) in `toolboxv2/mods/TTS.py`
- [`create_server`](../../mods/isaa/extras/tools/discord_tools.md) in `toolboxv2/mods/isaa/extras/tools/discord_tools.py`
- [`_encode`](../../utils/system/file_handler.md) in `toolboxv2/utils/system/file_handler.py`
- [`encode_code`](../../utils/security/cryp.md) in `toolboxv2/utils/security/cryp.py`
- [`from_dict`](../../mods/PasswordManager.md) in `toolboxv2/mods/PasswordManager.py`
- [`from_dict`](../../mods/Minu/shared.md) in `toolboxv2/mods/Minu/shared.py`
- [`_get_task_status_icon_from_dict`](../../mods/isaa/extras/terminal_progress2.md) in `toolboxv2/mods/isaa/extras/terminal_progress2.py`
- [`_get_task_status_color_from_dict`](../../mods/isaa/extras/terminal_progress2.md) in `toolboxv2/mods/isaa/extras/terminal_progress2.py`
