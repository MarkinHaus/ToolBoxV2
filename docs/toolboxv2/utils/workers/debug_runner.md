...
- [`get_metrics`](../../workers/event_manager.md) from `toolboxv2/utils/workers/event_manager.py` — ZMQ event broker and metrics.
- [`get_user_id_from_body`](../../workers/server_worker.md) from `toolboxv2/utils/workers/server_worker.py` — HTTP/WS worker infrastructure.
