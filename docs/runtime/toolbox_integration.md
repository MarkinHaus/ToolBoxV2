...
- `EventType`, `Event` from [event_manager](event_manager.md)

## Used By

- [server_worker](server_worker.md) — uses `check_access`, `AccessLevel`, `AccessController`, `is_public_endpoint`
- [config](config.md) — uses `AccessLevel`
- [session](session.md) — uses `AccessLevel`
